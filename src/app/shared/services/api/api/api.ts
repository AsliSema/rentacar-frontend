...
export const APIS = [BrandControllerService, CarControllerService, FuelControllerService, ModelControllerService, TransmissionControllerService, UserControllerService];
